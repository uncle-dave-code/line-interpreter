...
public class GreaterThanEqualExpression implements NonTerminalExpression {

    private Expression firstExpression, secondExpression;

    public GreaterThanEqualExpression(Expression firstExpression, Expression secondExpression) {
